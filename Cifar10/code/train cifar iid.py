...
def train_cifar_iid(q, q1, q2, q3, q4, q5):
    print(q,q1,q2,q3,q4,q5)
    file_name = "../Dataset100_clean_cifar10.pkl"
    ...
    for i in range(epochs):
        ...
        if i % 10 == 0 and i > 0:
            ...
            save_file_name = f'../data/Fair_cifar_zone_{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}.pkl'
...
if __name__ == "__main__":
 # Access the values of q, q1, q2, q3, q4, q5
    ...
    q4 = sys.argv[5]
    q5 = sys.argv[6]
    train_cifar_iid(float(q), float(q1), float(q2), float(q3), float(q4), float(q5))
