...
def train_femnist(q, q1, q2, q3, q4, q5):
    ...
    file_name_test = "../Dataset_test_3000.pkl"
    Testset = open_file(file_name_test)

    clients_test = Testset[0]
    clients_batched_test = dict()
    for (client_name, data) in clients_test.items():
        clients_batched_test[client_name] = batch_data_femnist(data)
    ...
    qm4 = q4
    qm5 = q5
    print('{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}', q, qm1, qm2, qm3, qm4, qm5)
    ...
    for i in range(epochs):
        ...
        if i % 5 == 0 and i > 0:
            ...
            sample_list = [global_accuracy, global_loss, group1_accuracy, group1_loss, group2_accuracy, group2_loss,
                           ...
                           group5_train_accuracy, group5_train_loss, global_weight_list]
            save_file_name = f'../data/Fair_femnist_{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}_all.pkl'
...
if __name__ == "__main__":
 # Access the values of q, q1, q2, q3, q4, q5
    ...
    q4 = sys.argv[5]
    q5 = sys.argv[6]
    train_femnist(float(q), float(q1), float(q2), float(q3), float(q4), float(q5))
