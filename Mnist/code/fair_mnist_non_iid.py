from utils.functions_new import  fed_avg,batch_data_non_iid_new, get_masked_model_chatgpt, SimpleMLP, save_file,  open_file, batch_data_non_iid, set_model_weights, get_cropped_model_chatgpt, group_gradient, group_hessian_new, norm_grad
...
for i in range(epochs):
    ...
    if i%10==0 and i>0:
        ...
        save_file_name= f'../data/Neurips/non-iid/Fair_mnist_noniid_zone_{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}.pkl'
        # save_file_name = f'../data/Neurips/extreme/Fair_mnist_noniid_extreme_zone_{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}_{num}.pkl'
