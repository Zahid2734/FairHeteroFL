...
def train_mnist_noniid(q, q1, q2, q3, q4, q5):
    ...
    for i in range(epochs):
        ...
        if i % 10 == 0 and i > 0:
            ...
            save_file_name = f'../data/Fair_mnist_noniid_zone_{q}_{qm1}_{qm2}_{qm3}_{qm4}_{qm5}_{epochs}_{lr}.pkl'
...
if __name__ == "__main__":
 # Access the values of q, q1, q2, q3, q4, q5
    ...
    q4 = sys.argv[5]
    q5 = sys.argv[6]
    train_mnist_noniid(float(q), float(q1), float(q2), float(q3), float(q4), float(q5))
